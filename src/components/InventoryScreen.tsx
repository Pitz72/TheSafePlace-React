    ...
    <div className="h-full flex flex-col items-center justify-center p-8 bg-black text-phosphor-primary font-mono">
      ...
      <div className="w-full max-w-6xl grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
        ...
        <div className="border border-phosphor-primary p-6 bg-gray-900 bg-opacity-80 glow-phosphor-dim animate-pulse">
          <h3 className="text-3xl font-bold mb-4 text-center text-phosphor-bright tracking-wider glow-phosphor-bright text-shadow-phosphor-bright">ZAINO</h3>
        ...
        <div className="border border-phosphor-primary p-6 bg-gray-900 bg-opacity-80 glow-phosphor-dim animate-pulse min-h-[300px]">
          <h3 className="text-3xl font-bold mb-4 text-center text-phosphor-bright tracking-wider glow-phosphor-bright text-shadow-phosphor-bright">DESCRIZIONE</h3>
          {selectedItem ? (
            <div className="space-y-4 text-xl">
              <p className="text-2xl text-phosphor-bright font-bold glow-phosphor-primary text-shadow-phosphor-bright">{selectedItem.name}</p>
              <p className="text-phosphor-dim italic">{selectedItem.description}</p>
            ...
            <p className="text-phosphor-dim text-xl italic">Seleziona un oggetto per vederne i dettagli.</p>
          )}
        </div>
      </div>
