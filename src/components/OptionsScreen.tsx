      ...
      <div className={`border border-phosphor-500 p-6 bg-gray-800 bg-opacity-90 glow-phosphor-dim animate-pulse`}>
        ...
        <div className="space-y-4">
          ...
          'text-phosphor-500 hover:bg-gray-800 hover:glow-phosphor-dim'
              ...
              >
                <div className="mb-2">
                  {isSelected && <span className="text-phosphor-300 mr-2 animate-pulse">►</span>}
                  <span className="text-phosphor-400 glow-phosphor-primary">[{item.shortcut?.[0]?.toUpperCase()}]</span> {item.label}
