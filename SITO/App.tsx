...
const App: React.FC = () => {
  ...
  return (
    <div className="bg-[#050a06] text-[#00ff41] text-xl overflow-x-hidden fade-in">
      ...
      <main className="max-w-5xl mx-auto px-5">
        ...
        <Section title="[VISUALIZZAZIONE_ARCHIVIO_IMMAGINI.IMG]">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
            <img src="/sfondo.png" alt="Copertina ufficiale di The Safe Place Chronicles: The Echo of the Journey." className="w-full h-auto border-2 border-[#008f25] hover:border-[#00ff41] transition-colors duration-300 col-span-1 sm:col-span-3"/>
            <img src="/sfondo.png" alt="Un ragazzo con uno zaino osserva una città futuristica in rovina, illuminata di verde." className="w-full h-auto border-2 border-[#008f25] hover:border-[#00ff41] transition-colors duration-300"/>
            <img src="/sfondo.png" alt="Artwork principale per il gioco The Safe Place Chronicles." className="w-full h-auto border-2 border-[#008f25] hover:border-[#00ff41] transition-colors duration-300 col-span-1 sm:col-span-2"/>
          </div>
        </Section>
